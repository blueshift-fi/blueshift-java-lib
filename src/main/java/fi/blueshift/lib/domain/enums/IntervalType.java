...
public enum IntervalType implements TemporalUnit {
    MINUTES_10("10m", Duration.ofSeconds(10), "10 minutes", "10m", null),
    HOURS_1("1h", Duration.ofSeconds(3600), "1 hour", "1h", null),
    HOURS_24("1D", Duration.ofSeconds(86400), "1 day", "24h", "1d"),
    WEEK_1("1W", Duration.ofSeconds(7 * 86400L), "1 week", "1w", "7d"),
    MONTHS_1("1M", Duration.ofSeconds(31556952L / 12), "1 month", "1month", "1M"),
    ...
    IntervalType(String typeName, Duration duration, String description, String nameIntervalForGlassnode, String nameIntervalForCoinMarket) {
    ...
    public static IntervalType fromType(String type) {
        return Arrays.stream(IntervalType.values()).parallel()
